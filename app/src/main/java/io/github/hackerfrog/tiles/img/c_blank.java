...
public class c_blank {

    Context context;
    Bitmap bitmap;
    int rotateCount = 0;
    public static int rotateMod = 1;

    public c_blank(Context context) {
        this.context = context;
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.c_blank);
